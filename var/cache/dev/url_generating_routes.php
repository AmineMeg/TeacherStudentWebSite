...
return [
    ...
    'Exos' => [['id'], ['_controller' => 'App\\Controller\\MoodleController::mesExos'], [], [['text', '/mesExos'], ['variable', '/', '[^/]++', 'id', true], ['text', '/cours']], [], []],
    'Exercice' => [['idCours', 'idExercice'], ['_controller' => 'App\\Controller\\MoodleController::exercice'], [], [['text', '/exercice'], ['variable', '/', '[^/]++', 'idExercice', true], ['variable', '/', '[^/]++', 'idCours', true], ['text', '/cours']], [], []],
